...
if __name__=="__main__":
    ...
    W_0=0.95; # Initial Wealth

    W_max=2.0;# Maximum Wealth
    n_w=15;#Divisions of wealth scale

    T=1.0;# End Time
    n_t=15; # Divisions on time scale
...
#                print(mu_current,mu,current_wealth,current_action);
                P_norm=10**(-10);
...
#        print(i_state)
        for i_action in range(num_actions):
            P[i_action,i_state,:]=deepcopy(P[i_action,i_state,:]/(sum(P[i_action,i_state,:])+10**(-10)))
